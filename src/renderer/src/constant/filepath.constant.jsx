export let ORTHANCE_SERVER_DESTINATION_FOLDER = "C://Orthanc server" ; 
export let ORTHANCE_SOURCE_FOLDER = "./Orthanc server" ; 
export let WIN_EXE_ORTAHNC_FOLDER = "./app/Orthanc server" ;
export let ORTAHNCE_FOLDER = "Orthanc server" ;  
